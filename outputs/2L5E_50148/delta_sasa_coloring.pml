reinitialize
load ./outputs/2L5E_50148/2L5E_delta_sasa.pdb, structure
hide everything, structure
show cartoon, structure
color green, structure and chain B
# Delta SASA range: 0.00 to 10.98 Å²
spectrum b, blue_white_red, structure and chain A, minimum=0.00, maximum=10.98
...
# Fraction occluded: 10.24%
# SASA threshold: 0.0 Å²
# Average percent burial: 1.0%
# Heatmap: Blue (low ΔSASA) -> White -> Red (high ΔSASA)
# Backbone colored by delta SASA values (protein-peptide occlusion)
# Modified PDB file: /Users/tiburon/Desktop/GTM_Research/01_Active_Projects/new_CSP_UBQ/CSP_UBQ/outputs/2L5E_50148/2L5E_delta_sasa.pdb
