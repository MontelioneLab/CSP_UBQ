reinitialize
load ./outputs/6IJQ_18792/6ijq_csp.pdb, structure
...
color tp_color, structure and chain B and resi 52
color tp_color, structure and chain B and resi 54
color tp_color, structure and chain B and resi 57
color tp_color, structure and chain B and resi 151
color tp_color, structure and chain B and resi 155
# FP (Sig. CSP -- Allosteric): 77 residues
color fp_color, structure and chain B and resi 1
...
color fp_color, structure and chain B and resi 25
...
color fp_color, structure and chain B and resi 64
...
color fp_color, structure and chain B and resi 96
color fp_color, structure and chain B and resi 97
color fp_color, structure and chain B and resi 102
color fp_color, structure and chain B and resi 105
color fp_color, structure and chain B and resi 110
color fp_color, structure and chain B and resi 112
color fp_color, structure and chain B and resi 121
...
color fp_color, structure and chain B and resi 149
color fp_color, structure and chain B and resi 153
color fp_color, structure and chain B and resi 156
...
color fp_color, structure and chain B and resi 166
...
# TN (low CSP -- Allosteric): 68 residues
...
color tn_color, structure and chain B and resi 117
...
color tn_color, structure and chain B and resi 131
...
color tn_color, structure and chain B and resi 164
...
color fn_color, structure and chain B and resi 53
color fn_color, structure and chain B and resi 61
color fn_color, structure and chain B and resi 98
color fn_color, structure and chain B and resi 99
...
# FP (Sig. CSP -- Allosteric): 77
# TN (low CSP -- Allosteric): 68
# FN (low CSP in Union Site): 5
# Residues without CSP data: 16
# Structure colored by CSP classification (TP/FP/TN/FN)
# Modified PDB file: /Users/tiburon/Desktop/GTM_Research/01_Active_Projects/new_CSP_UBQ/CSP_UBQ/outputs/6IJQ_18792/6ijq_csp.pdb
