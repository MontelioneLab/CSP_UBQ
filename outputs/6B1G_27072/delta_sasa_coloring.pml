reinitialize
load ./outputs/6B1G_27072/6B1G_delta_sasa.pdb, structure
hide everything, structure
show cartoon, structure
color green, structure and chain B
# Delta SASA range: 0.00 to 15.98 Å²
spectrum b, blue_white_red, structure and chain A, minimum=0.00, maximum=15.98
...
# Fraction occluded: 20.00%
# SASA threshold: 0.0 Å²
# Average percent burial: 4.4%
# Heatmap: Blue (low ΔSASA) -> White -> Red (high ΔSASA)
# Backbone colored by delta SASA values (protein-peptide occlusion)
# Modified PDB file: /Users/tiburon/Desktop/GTM_Research/01_Active_Projects/new_CSP_UBQ/CSP_UBQ/outputs/6B1G_27072/6B1G_delta_sasa.pdb
