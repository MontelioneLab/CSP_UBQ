reinitialize
load ./outputs/2H7D_15792/2H7D_delta_sasa.pdb, structure
hide everything, structure
show cartoon, structure
color green, structure and chain B
# Delta SASA range: 0.00 to 5.28 Å²
spectrum b, blue_white_red, structure and chain A, minimum=0.00, maximum=5.28
...
# Fraction occluded: 11.88%
# SASA threshold: 0.0 Å²
# Average percent burial: 0.5%
# Heatmap: Blue (low ΔSASA) -> White -> Red (high ΔSASA)
# Backbone colored by delta SASA values (protein-peptide occlusion)
# Modified PDB file: /Users/tiburon/Desktop/GTM_Research/01_Active_Projects/new_CSP_UBQ/CSP_UBQ/outputs/2H7D_15792/2H7D_delta_sasa.pdb
