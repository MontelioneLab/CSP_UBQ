...
\caption{\textbf{SI Table S11. Data for BET-ET Domain Receptors}}
\label{tab:st11} \\
\toprule
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{SF10_BET_ET.png}
\captionsetup{labelformat=empty}
\caption{\textbf{SI Fig. S10. Confusion Matrix Histograms for BET-ET Domain Receptors}}
\label{fig:sf10_bet_et}
\end{figure}
