...
\caption{\textbf{SI Table S12. Data for TFIIH Domain Receptors}}
\label{tab:st12} \\
\toprule
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{SF11_TFIIH.png}
\captionsetup{labelformat=empty}
\caption{\textbf{SI Fig. S11. Confusion Matrix Histograms for TFIIH Domain Receptors}}
\label{fig:sf11_tfiih}
\end{figure}
