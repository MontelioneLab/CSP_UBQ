...
\captionsetup{labelformat=empty}
\caption{\textbf{SI Fig. S7. Confusion Matrix Histograms for TFIIH Domain Receptors} ($n=9$)}
\label{fig:sf7_tfiih}
\end{figure}
