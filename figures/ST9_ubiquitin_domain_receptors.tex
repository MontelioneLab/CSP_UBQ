...
\caption{\textbf{SI Table S9. Data for Ubiquitin Domain Receptors}}
\label{tab:st9} \\
\toprule
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{SF8_ubiquitin.png}
\captionsetup{labelformat=empty}
\caption{\textbf{SI Fig. S8. Confusion Matrix Histograms for Ubiquitin Domain Receptors} ($n=3$)}
\label{fig:sf8_ubiquitin}
\end{figure}
