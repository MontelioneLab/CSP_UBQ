...
\caption{\textbf{SI Table S8. Data for Ubiquitin Domain Receptors}}
\label{tab:st8} \\
\toprule
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{SF7_ubiquitin.png}
\captionsetup{labelformat=empty}
\caption{\textbf{SI Fig. S7. Confusion Matrix Histograms for Ubiquitin Domain Receptors} ($n=3$)}
\label{fig:sf7_ubiquitin}
\end{figure}
