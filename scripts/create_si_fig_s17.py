#!/usr/bin/env python3
"""
SI Fig. S17 — ideal N/H offsets (offset grid heatmap from grid search).

Reads grid search CSV files from outputs/, creates the heatmap, and saves to
./figures/SF17_ideal_offsets.png.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Create SI Fig. S17 (ideal N/H offsets heatmap).")
    ...
    print(f"SI Fig. S17 saved to {suppl_path.resolve()}")
    return 0
