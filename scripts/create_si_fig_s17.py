#!/usr/bin/env python3
"""
SI Fig. S17 — CSP significance threshold histogram.
...
Output: figures/SF17_significance_threshold.png
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Create SI Fig. S17 (CSP significance threshold histogram)"
    )
    ...
    parser.add_argument("--output", type=Path, default=Path("figures") / "SF17_significance_threshold.png")
    ...
    print(f"SI Fig. S17 written to {output_path.resolve()}")
    return 0
