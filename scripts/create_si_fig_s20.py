#!/usr/bin/env python3
"""
SI Fig. S20 — buffer-threshold sweep heatmaps.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Create SI Fig. S20 (buffer threshold sweep).")
...
def main() -> int:
    ...
    print(f"SI Fig. S20 saved to {output_path.resolve()}")
    return 0
