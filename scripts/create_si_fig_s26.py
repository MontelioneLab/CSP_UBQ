#!/usr/bin/env python3
"""
SI Fig. S26 — Case study panel for holo 2FIN / apo BMRB 6809.

Copies the precomputed case-study z panel into ``figures/SF26_2FIN_case_study_z.png``.
...
DEFAULT_OUT = _REPO / "figures" / "SF26_2FIN_case_study_z.png"
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(f"[SF26] Wrote {out} (from {src})")
    return 0
