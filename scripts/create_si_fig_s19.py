#!/usr/bin/env python3
"""
SI Fig. S19 — CSP significance threshold histogram.
...
Output: figures/SF19_significance_threshold.png
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Create SI Fig. S19 (CSP significance threshold histogram)"
    )
    ...
    parser.add_argument("--output", type=Path, default=Path("figures") / "SF19_significance_threshold.png")
    ...
    print(f"SI Fig. S19 written to {output_path.resolve()}")
    return 0
