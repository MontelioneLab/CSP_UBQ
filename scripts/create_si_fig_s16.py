#!/usr/bin/env python3
"""
SI Fig. S16 — Figure 3 histograms for the same-author/same-study subset.

Thin wrapper around ``create_fig_3.py`` with SI defaults
(``data/CSP_UBQ_ph0.5_temp5C_same_author_list.csv`` → SF16 combined PNG).
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument(
        "--output-combined",
        type=Path,
        default=_REPO / "figures" / "SF16_figure_3_combined_same_author_list.png",
    )
