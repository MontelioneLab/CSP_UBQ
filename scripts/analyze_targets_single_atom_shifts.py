...
rule for SI Fig. S10 / S12 / S14 and the standalone 1D F1 boxplot (default
...
def target_basenames_passing_ca_shift_coverage(
    ...
    *,
    ...
    Shared eligibility rule for SI Fig. S10 / S12 / S14 and the standalone 1D F1 boxplot so CA-shift
