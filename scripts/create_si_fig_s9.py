#!/usr/bin/env python3
"""
SI Fig. S9 — Figure 3 histograms for the same-author/same-study subset.

Thin wrapper around ``create_fig_3.py`` with SI defaults
(``data/CSP_UBQ_ph0.5_temp5C_same_author_list.csv`` → SF9 combined PNG).
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument(
        "--output-combined",
        type=Path,
        default=_REPO / "figures" / "SF9_figure_3_combined_same_author_list.png",
    )
